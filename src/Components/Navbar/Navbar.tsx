...
const Navbar = ({ search, setSearch, handleFilterModalClick }) => {
  return (
    <div
      className='navbar flex absolute justify-around box-border z-10 h-[9vh] w-[100vw] bg-black'
      data-testid='navbar'
    >
      ...
      <div className='navbar_search h-full flex items-center'>
        ...
        />
        <button
          className='filter-icon text-3xl cursor-pointer bg-black text-white border-none m-2'
