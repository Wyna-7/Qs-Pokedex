...
const PokeCard = ({ id, name, gif_front, gif_back }: Partial<Pokemon>) => {
  return (
    <div className='group m-2 p-5 w-[200px] h-[270px] [perspective:1000px] drop-shadow-lg'>
      <div className='pokeCard flex flex-col w-[200px] h-[270px] relative justify-around bg-white size-full rounded-2xl transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]'>
