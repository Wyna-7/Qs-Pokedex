...
const FilterModal = ({ closeModal, selectedFilters, setSelectedFilters }: FilterModalProps) => {
  ...
  useEffect(() => {
    try {
      ...
      console.error('There was an error getting the pokémon types: ', error);
    }
    try {
      ...
      console.error('There was an error getting the pokémon games: ', error);
    }
  ...
  return (
    <div className='filter-modal flex fixed  w-[100vw] h-[100vh]'>
      <div className='overlay fixed bg-[rgba(49,49,49,0.8)] flex  w-[100vw] h-[100vh]' onClick={closeModal}></div>
      <form
      ...
      >
        <div>
          <fieldset>
            <legend className='types-legend font-bold mb-1'>Choose one or more types:</legend>
          ...
          <fieldset>
            <legend className='games-legend font-bold mt-4 mb-1'>Choose one or more games:</legend>
